...
private:
    SparkMax m_left_drive;
    SparkMax m_right_drive;
    SparkMax m_left_back_coll;
    SparkMax m_right_back_coll;
    SparkMax m_exc_internal;
    SparkMax m_exc_thread_rod;
    SparkMax m_exc_pivot_lin;
    std::mutex lock_;
    rclcpp::Logger logger_;
    std::array<rclcpp::SubscriptionBase::SharedPtr, constants::N_INPUTS> gamepad_subscribers;
