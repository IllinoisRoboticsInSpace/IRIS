...
#define RIGHT_COLLECTION_MOTOR 1       // M1
#define DRIVE_RIGHT_MOTOR 2             // M2

// Sabertooth 2
// Motors S(1,2): Excavator Internal Motor, Excavator Threaded Rod Actuator
#define S2_SABER_ADDRESS 129            // DIP switch address
#define S2_SABER_SERIAL Serial1         // Hardware Serial TX2
#define EXCAVATOR_INTERNAL_MOTOR 1      // M1
#define EXCAVATOR_THREADED_ROD 2        // M2

// Sabertooth 3
// Motors S(1,2): Left Back Collection Motor, Left Drive Motor
#define S3_SABER_ADDRESS 130            // DIP switch address
#define S3_SABER_SERIAL Serial1         // Hardware Serial TX3
#define LEFT_COLLECTION_MOTOR 1         // M1
#define DRIVE_LEFT_MOTOR 2              // M2
